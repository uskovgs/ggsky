...
- label_offset_lon:
  ...
  Numeric scalar in npc units. Vertical offset for galactic-longitude
  labels relative to the equator.

- label_offset_lat:

  Numeric scalar in npc units. Outward offset for galactic-latitude
  labels relative to the projection outline.
